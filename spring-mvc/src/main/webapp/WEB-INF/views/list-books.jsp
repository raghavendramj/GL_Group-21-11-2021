...
<body>
	...
	<div class="container">
		...
		<!-- Add a search form -->
		<form action="/spring-mvc/books/search" class="form-inline">

			<!-- Add a button -->
			<a href="/spring-mvc/books/showFormForAdd"
				...
				<c:forEach items="${Books}" var="tempBook">
					<tr>
						...
						<td>
							...
							href="/spring-mvc/books/showFormForUpdate?bookId=${tempBook.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a href="/spring-mvc/books/delete?bookId=${tempBook.id}"
